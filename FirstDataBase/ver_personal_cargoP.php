<?php
    ...
    if($privilegio >= 0){
        ...
        $resultado2 = mysqli_query($bd,"SELECT DNI FROM Participante&Cargos WHERE idCargo_Proceso = $c");

        $row1 = mysqli_fetch_array($resultado2);     

        $resultado = mysqli_query($bd,"SELECT * FROM Participante WHERE DNI = '$row1[0]'");
